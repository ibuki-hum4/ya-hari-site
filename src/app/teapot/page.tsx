                ...
                <div className="text-center">
                    <div className="relative mb-8">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-6xl text-amber-600 dark:text-amber-400 animate-bounce">
                                <TbTeapot />
                            </div>
                        </div>
                    </div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-500 mb-8 max-w-md mx-auto font-mono">
                        {t("teapot.rfc")}
                    </p>

    ...
    return (
        <section id="about" className="py-20 px-8 bg-gray-50 dark:bg-gray-800">
            <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-12 text-center">About</h2>
                
                <div className="grid md:grid-cols-2 gap-12">
                    {/* プロフィール */}
                    <div className="bg-white dark:bg-gray-700 rounded-2xl p-8 shadow-sm">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">やーはり</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">14歳 / 中学2年生</p>

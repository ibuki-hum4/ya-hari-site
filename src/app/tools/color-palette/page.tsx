...
export const metadata = {
    title: "Color Palette Generator | やーはり",
    description: "Pick one color and generate complementary, analogous, and triadic palettes.",
    alternates: { canonical: "/tools/color-palette" },
    openGraph: { type: "website", url: `${siteUrl}/tools/color-palette`, title: "Color Palette Generator | やーはり", description: "Pick one color and generate complementary, analogous, and triadic palettes." },
    twitter: { card: "summary", title: "Color Palette Generator | やーはり", description: "Pick one color and generate complementary, analogous, and triadic palettes." },
};

export default async function ToolPage() {
    const t = await getTranslations("tools.colorPalette");
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="pt-20 flex-1">
                <Section>
                    ...
                    <Reveal delay={0.3}><ColorPalette /></Reveal>
                </Section>
            </main>
            <Footer />
        </div>

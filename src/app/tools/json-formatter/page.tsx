...
export const metadata = {
    title: "JSON Formatter / Diff | やーはり",
    description: "Format and validate JSON. Compare two JSON objects and see a diff.",
    alternates: { canonical: "/tools/json-formatter" },
    openGraph: { type: "website", url: `${siteUrl}/tools/json-formatter`, title: "JSON Formatter / Diff | やーはり", description: "Format and validate JSON. Compare two JSON objects and see a diff." },
    twitter: { card: "summary", title: "JSON Formatter / Diff | やーはり", description: "Format and validate JSON. Compare two JSON objects and see a diff." },
};
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="pt-20 flex-1">
                <Section>
                    ...
                    <Reveal delay={0.3}><JsonFormatter /></Reveal>
                </Section>
            </main>
            <Footer />
        </div>

...
export const metadata = {
    title: "YAML ↔ JSON Converter | やーはり",
    description: "Convert between YAML and JSON. Useful for config file transformations.",
    alternates: { canonical: "/tools/yaml-json" },
    openGraph: { type: "website", url: `${siteUrl}/tools/yaml-json`, title: "YAML ↔ JSON Converter | やーはり", description: "Convert between YAML and JSON. Useful for config file transformations." },
    twitter: { card: "summary", title: "YAML ↔ JSON Converter | やーはり", description: "Convert between YAML and JSON. Useful for config file transformations." },
};

export default async function ToolPage() {
    const t = await getTranslations("tools.yamlJson");
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="pt-20 flex-1">
                <Section>
                    ...
                    <Reveal delay={0.3}><YamlJson /></Reveal>
                </Section>
            </main>
            <Footer />
        </div>
